...
The iOS Xcode project is generated by CMake and is not checked into the repository. To generate `ARMSX2iOS.xcodeproj` and build an unsigned test IPA, see [docs/ios-build.md](docs/ios-build.md).
